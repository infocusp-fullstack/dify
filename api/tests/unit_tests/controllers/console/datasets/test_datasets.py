...
class TestDatasetListApiPost:
    def test_post_success(self, app):
        ...
        with app.test_request_context("/datasets", json=payload), \
    ...
    def test_post_invalid_payload_missing_name(self, app):
        ...
        with app.test_request_context("/datasets", json={}), \
...
class TestDatasetApiGet:
    def test_get_success_basic(self, app):
        ...
        with app.test_request_context(f"/datasets/{dataset_id}"), \
            ...
            patch(
                "controllers.console.datasets.datasets.ProviderManager"
            ) as provider_manager_mock:
...
class TestDatasetApiPatch:
    ...
    def test_patch_dataset_not_found(self, app):
        ...
        with app.test_request_context("/datasets/missing"), \
            patch.object(
                DatasetService,
                "get_dataset",
                return_value=None,
...
class TestDatasetUseCheckApi:
    def test_get_use_check_true(self, app):
        ...
        with app.test_request_context(f"/datasets/{dataset_id}/use-check"), \
            patch.object(
                DatasetService,
                "dataset_use_check",
                return_value=True,
...
class TestDatasetQueryApi:
    def test_get_queries_success(self, app):
        ...
        with app.test_request_context("/datasets/queries?page=1&limit=20"), \
            patch(
                "controllers.console.datasets.datasets.current_account_with_tenant",
                return_value=(current_user, "tenant-1"),
            ), \
    ...
    def test_get_queries_dataset_not_found(self, app):
        ...
        with app.test_request_context("/datasets/queries"), \
            patch(
                "controllers.console.datasets.datasets.current_account_with_tenant",
                return_value=(current_user, "tenant-1"),
            ), \
        ...
        with app.test_request_context("/"), \
            ...
            patch(
                ...
                return_value=MagicMock(
                    where=lambda *args, **kwargs: MagicMock(count=lambda: 3)
                ),
            ):
            response, status = method(api, "dataset-1")
    ...
    def test_post_exceed_max_keys(self, app):
        ...
        with app.test_request_context("/"), \
            ...
            patch(
                "controllers.console.datasets.datasets.db.session.query",
                return_value=MagicMock(
                    where=lambda *args, **kwargs: MagicMock(count=lambda: 10)
                ),
            ):
    ...
    def test_delete_success(self, app):
        ...
        with app.test_request_context("/"), \
            ...
            patch(
                "controllers.console.datasets.datasets.db.session.query",
                return_value=MagicMock(
                    where=lambda *args, **kwargs: MagicMock(first=lambda: mock_key)
                ),
            ), \
            patch(
                "controllers.console.datasets.datasets.db.session.commit",
    ...
    def test_delete_key_not_found(self, app):
        ...
        with app.test_request_context("/"), \
            ...
            patch(
                "controllers.console.datasets.datasets.db.session.query",
                return_value=MagicMock(
                    where=lambda *args, **kwargs: MagicMock(first=lambda: None)
                ),
            ):
            with pytest.raises(NotFound):
