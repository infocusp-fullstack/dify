...
class TestMessageListApi:
    def test_get_success(self, app):
        ...
        with app.test_request_context(
            ...
            module, "current_account_with_tenant", return_value=(MagicMock(), None)
        ), patch.object(
...
class TestMessageFeedbackApi:
    def test_post_success(self, app):
        ...
        with app.test_request_context("/", json={"rating": "like"}), patch.object(
            module, "current_account_with_tenant", return_value=(MagicMock(), None)
        ), patch.object(
            module.MessageService,
            "create_feedback",
    ...
    def test_message_not_exists(self, app):
        ...
        with app.test_request_context("/", json={}), patch.object(
            module, "current_account_with_tenant", return_value=(MagicMock(), None)
        ), patch.object(
            module.MessageService,
            "create_feedback",
