...
class TestInstalledAppWorkflowTaskStopApi:
    ...
    def test_success(self, installed_workflow_app):
        ...
        with patch(
            "controllers.console.explore.workflow.AppQueueManager.set_stop_flag_no_user_check"
        ) as stop_flag, patch(
            "controllers.console.explore.workflow.GraphEngineManager.send_stop_command"
        ) as send_stop:
