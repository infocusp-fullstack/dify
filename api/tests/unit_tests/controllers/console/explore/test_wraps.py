...
def test_installed_app_required_not_found():
    ...
    with patch(
        ...
        "controllers.console.explore.wraps.db.session.query"
    ) as q:
...
def test_installed_app_required_app_deleted():
    ...
    with patch(
        ...
        "controllers.console.explore.wraps.db.session.delete"
    ), patch(
        "controllers.console.explore.wraps.db.session.commit"
    ):
